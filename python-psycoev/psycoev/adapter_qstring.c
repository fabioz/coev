...
qstring_quote(qstringObject *self)
{
    ...
    buffer = psycoev_escape_string(self->conn, s, len, NULL, &qlen);
...
{
    return PyString_FromFormat("<psycoev._psycoev.QuotedString object at %p>",
                                self);
}
