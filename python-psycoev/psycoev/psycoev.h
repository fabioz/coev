/* psycoev.h - definitions for the psycoev python module
 *
...
#define PSYCOPG_API_pointers 2
    ...
    /** This section is used when compiling psycoevmodule.c & co. **/
...
#else
    /** This section is used in modules that use psycoev's C API **/
...
import_psycoev(void)
{
    PyObject *module = PyImport_ImportModule("psycoev");
...
HIDDEN char *psycoev_escape_string(PyObject *conn,
