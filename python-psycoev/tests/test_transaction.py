...
import psycoev
from psycoev.extensions import (
...
class TransactionTests(unittest.TestCase):
    ...
    def test_failed_commit(self):
        ...
        self.assertEqual(self.conn.status, STATUS_BEGIN)
        self.assertRaises(psycoev.IntegrityError, self.conn.commit)
        self.assertEqual(self.conn.status, STATUS_READY)
...
class DeadlockSerializationTests(unittest.TestCase):
    ...
    def test_deadlock(self):
        ...
        def task1():
            ...
            except psycoev.DatabaseError, exc:
        ...
        self.assertTrue(isinstance(
                error, psycoev.extensions.TransactionRollbackError))
...
class QueryCancelationTests(unittest.TestCase):
    ...
    def test_statement_timeout(self):
        ...
        self.assertRaises(psycoev.extensions.QueryCanceledError,
