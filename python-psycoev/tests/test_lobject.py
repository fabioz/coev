...
class LargeObjectTests(unittest.TestCase):
    ...
    def tearDown(self):
        ...
        if self.lo_oid is not None:
            ...
            except psycoev.OperationalError:
                pass
            else:
                lo.unlink()
    ...
    def test_open_non_existent(self):
        ...
        lo = self.conn.lobject()
        lo.unlink()
        self.assertRaises(psycoev.OperationalError, self.conn.lobject, lo.oid)
    ...
    def test_create_with_existing_oid(self):
        ...
        self.assertRaises(psycoev.OperationalError,
    ...
    def test_write_after_close(self):
        lo = self.conn.lobject()
        lo.close()
        self.assertRaises(psycoev.InterfaceError, lo.write, "some data")

    def test_read_after_close(self):
        lo = self.conn.lobject()
        lo.close()
        self.assertRaises(psycoev.InterfaceError, lo.read, 5)

    def test_seek_after_close(self):
        lo = self.conn.lobject()
        lo.close()
        self.assertRaises(psycoev.InterfaceError, lo.seek, 0)

    def test_tell_after_close(self):
        lo = self.conn.lobject()
        lo.close()
        self.assertRaises(psycoev.InterfaceError, lo.tell)
    ...
    def test_write_after_commit(self):
        ...
        self.assertRaises(psycoev.ProgrammingError, lo.write, "some data")
    ...
    def test_read_after_commit(self):
        ...
        self.assertRaises(psycoev.ProgrammingError, lo.read, 5)
    ...
    def test_seek_after_commit(self):
        ...
        self.assertRaises(psycoev.ProgrammingError, lo.seek, 0)
    ...
    def test_tell_after_commit(self):
        ...
        self.assertRaises(psycoev.ProgrammingError, lo.tell)
