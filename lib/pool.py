"""Connection pooling for psycoev
...
try:
    ...
    # create logger object for psycoev module and sub-modules
    _logger = logging.getLogger("psycoev")
    def dbg(*args):
        _logger.debug("psycoev", ' '.join([str(x) for x in args]))
    try:
